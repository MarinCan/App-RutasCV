...
router.post('/', async (req, res) => {
    ...
    var consulta_img = ` SELECT * from img_rutas JOIN rutas ON img_rutas.id_img_ruta = rutas.id WHERE rutas.id IN ( SELECT id FROM rutas WHERE parque_natural = '${parque}' ) GROUP BY img_rutas.id_img_ruta LIMIT 1 `
